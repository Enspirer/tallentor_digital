                    ...
                    <div class="body">
                        <div class="company">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item"><a href="#" class="nav-link">Expert Centre</a></li>
                ...
                <div class="contact-info">
                    ...
                    <div class="footer" style="padding: 20px;">
                        <div class="newsletter">
                            <label for="newsletter"><button type="submit" class="submit-btn"
                                    style="height: 32px;">SUBSCRIBE</button></label>
                            <input style="height: 40px;" type="email" name="newsletter" id="newsletter"
